...
In this last assignment, you will practice the programming techniques from Lectures 10–14 and review core tools from earlier in the course. Part 1 includes guided exercises with a built-in dataset, while Part 2 focuses on a more realistic setting using a real social science dataset
...
1. Go at [this link](https://classroom.github.com/a/JAgJxWZS) to accept the invitation and create your private `hw04` repository on GitHub. Your repository will be named `hw04-<USERNAME>` and will be ready within a few seconds. 
